...
public class DocumentRepository implements DocumentDAO {
    ...
    public Document save(String id, Document document) {
        try{
            ...
            if (null == _document) {
               template.update( sql.get("insert"), new Object[] {id, document.getName(), document.getLocation(),
                                document.getDescription(), document.getType().getTypeId(),
                ...
                template.update(sql.get("update"), new Object[] {_document.getName(), _document.getLocation(), _document.getDescription(),
                                _document.getType().getTypeId(), new Date(), id });
